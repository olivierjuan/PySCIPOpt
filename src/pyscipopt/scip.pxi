...
cdef class Model:
    ...
    def executeBranchRule(self, str name, allowaddcons):
        ...
        cdef SCIP_Bool c_allowaddcons = allowaddcons
        ...
        PY_SCIP_CALL(_callBranchruleExeclp(self._scip, branchrule, c_allowaddcons, &result))
        return result
    ...
    def getState(self, prev_state = None):
        ...
        for i in range(ncols):
            ...
            # Age
            col_ages[col_i] = SCIPcolGetAge(cols[i])
